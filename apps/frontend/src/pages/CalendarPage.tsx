  ...
  return (
    <div className="p-4 grid grid-cols-4 gap-4">
      <div className="col-span-3 bg-white p-3 rounded">
        ...
        <FullCalendar plugins={[dayGridPlugin, timeGridPlugin, listPlugin, interactionPlugin]} initialView="dayGridMonth" headerToolbar={{ left: 'prev,next today', center: 'title', right: 'dayGridMonth,timeGridWeek,timeGridDay,listWeek' }} events={events} eventClick={(i: EventClickArg) => setSelected(i.event)} />
      </div>
