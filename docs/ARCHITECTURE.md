...
```mermaid
flowchart TD
    A[Create schedule event] --> B[Apply recurrence and validation]
    B --> C[Render calendar/admin workflow]
    C --> D[Export/share and refine planning]
...
| Category | Value |
| --- | --- |
| Primary stack | TypeScript, React, Node.js, PostgreSQL, Prisma |
| Repository type | Public portfolio |
| GitHub topics | calendar, express, postgresql, prisma, react, typescript |
